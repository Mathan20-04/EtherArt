...
export class CartService extends BaseService {
  ...
  private urlGetActivity = 'main/item-activity/items-activity'
  ...
  getActivityDataById(params: any) : Observable<any> {
    return this.getListCommon(this.urlGetActivity,params,false)
    .pipe(
      map(data => {
        return data;
      }),
