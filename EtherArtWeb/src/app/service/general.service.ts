...
export class GeneralService extends BaseService {
  ...
  private urlCryptoHist = '/main/crypto-rates/stock'
  ...
  private urlCF = 'https://sandbox.cashfree.com/pg/orders'
  ...
  getCryptoHistoricalData(params) : Observable<any> {
    return this.getListCommon(this.urlCryptoHist, params, false)
      .pipe(
        map(data => {
        return data;
        }),
  ...
  createCFOrder(param): Observable<any> {
    return this.postCommon(this.urlCF,param,false,true,null,true)
      .pipe(
        map(data => {
        return data;
        }),
